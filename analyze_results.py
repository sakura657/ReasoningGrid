...
BASE_DIR = "/home/ubuntu/sober-reasoning/output"
...
def process_experiment(exp_path, tokenizer):
    ...
    try:
        ...
        dataset = '-'.join(config_parts[4:])  # Join remaining parts as dataset name
    except IndexError:
        seed, temperature, top_p, dtype, dataset = "unknown", "unknown", "unknown", "unknown", "unknown"
